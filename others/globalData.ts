...
const espWorkExp: Array<JobDetail> = [
  ...
  },
  {
    ...
    time: '1.6 Años (Trabajo actual)',
    description: 'Aquí desarrollé muchos proyectos diferentes y logré mejorar mi pila anterior de tecnologías, también entendí y aprendí a usar otras tecnologías, como Graph QL, más implementaciones de back-end con diferentes bases de datos como mongo db, mariaDB y algunas configuraciones de infraestructura como servicios Docker o AWS'
  }
];
